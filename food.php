      ...
      <div class="row">
        <div class="col-md-6">
          <div class="dish_container">
            <div class="box">
              <img src="images/mg.jpg" style="border-radius:20px" alt="">
            </div>
            <div class="box">
              <img src="images/bn.jpg" style="border-radius:20px"alt="">
            </div>
            <div class="box">
              <img src="images/gv.jpg"style="border-radius:20px" alt="">
            </div>
            <div class="box">
              <img src="images/fr.jpg" style="border-radius:20px" alt="">
            </div>
          </div>
        </div>
        <div class="col-md-6">
          <div class="detail-box">
            ...
            <p>
              "Our fruits are naturally ripened, free from artificial preservatives, 
              and packed with essential vitamins and nutrients for a healthy lifestyle."
            </p>
          </div>
        </div>
      </div>
