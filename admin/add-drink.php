...
<head>
    ...
    <title>Fresh vegetable Menu</title>
...
<body>
    <div class="row">
        ...
        &nbsp;<br>
        <img src="img/ave.jpg" width="450" style="margin-left:200px;
       border-radius: 20px; margin-top: 20px; " />
        ...
        <div class="header">
            ...
            <div class="header-buttons">
                ...
                <a href="drink.php" id="addButton2" class="cool2">< Back </a>
        ...
        include('connection.php');
            if(isset($_POST['aaa'])) {
                ...
                $query=mysqli_query($con, "insert into drinklist(img,Name,Description,Price) value('$image','$product_name','$product_desc','$product_price')");
        ...
        <div id="addFoodForm">
            <form method="POST" enctype="multipart/form-data">
                ...
                <button type="submit" name="aaa">Submit</button>
            </form>
        </div>  
    </div></div>
        <div class="col-1"></div>
