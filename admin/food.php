...
<body translate="no" >
   ...
   <div class="row">
    ...
    <div class="col-4"> 
        ...
        <h1><span class="gold">Fruits List</h1>
    </div>
    <div class="col-2">
    ...
    <div class="col-2">
    &nbsp;<br>
    <a href="add-food.php" id="addButton" class="cool">+ Add Fruits</a>
