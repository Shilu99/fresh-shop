...
<body translate="no" >
   ...
   <div class="row">
    ...
    <div class="col-4"> 
        ...
        <h1><span class="gold">Vegetables List</h1>
    </div>
    <div class="col-2">
    ...
    <div class="col-2">
    &nbsp;<br>
    <a href="add-drink.php" id="addButton" class="cool">+ Add Vegetables</a>
...
while(list($id,$name,$price,$dis,$img) = mysqli_fetch_array($val)){
    ...
    echo "<td><img src='./img/$img'
     height='100' width='100' style='border-radius:20px;' /></td>";
    echo "<td><a href='delete-drink.php?id=$id&img=$img'>
    <img src='img/deletef.webp' style='border-radius:20px; margin-left:-20px' width='80'/></a></td>";
    echo "<td><a href='edit-drink.php?id=$id'>
    <img src='img/editf.webp' style='border-radius:20px; margin-left:-20px' width='80'/></a></td>";
